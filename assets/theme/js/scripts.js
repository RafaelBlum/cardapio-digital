$(function () {
    ...
    sr.reveal('.pricing, .footer-title', {
            origin: 'top',
            distance: '60px',
            duration: 2500,
            delay: 400,
    ...
    sr.reveal('.products-card' , {origin: 'bottom'});
    sr.reveal('.blog-card .single-pricing' , {origin: 'left'});
    sr.reveal('.subscribe' , {origin: 'right', duration: 1000});
